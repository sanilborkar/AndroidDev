...
import com.sanilborkar.weathercast.data.*;

public class ProcessResponse {

		public static Weather extractWeatherInfo(String data) throws JSONException  {
			...
			JSONArray jsonArr = jObj.getJSONArray("weather");
		...
		public static ForecastData extractWeatherForecast(String data) throws JSONException  {
